...
use super::ascii::{CR, CRLF_LEN, LF};
use super::server::MAX_PAYLOAD_SIZE;
use super::{find, Body, ConnectionError, HttpHeaderError, Request, RequestError, RequestHeaders, RequestLine, Response, StatusCode};
        ...
        match find(&self.buffer[*line_start_index..end_cursor], &[CR, LF]) {
            ...
            Some(0) => {
                ...
                if request.headers.content_length() == 0 {
                    ...
                    request.body = Some(super::Body::new(vec![]));
...
mod tests {
    ...
    use crate::micro_http::server::MAX_PAYLOAD_SIZE;
    use crate::micro_http::{Method, Version};
    ...
    fn test_try_read_expect() {
        ...
        let expected_request = Request {
            ...
            headers: RequestHeaders::new(26, true, true),
    ...
    fn test_try_read_long_request_body() {
        ...
        let expected_request = Request {
            request_line: RequestLine::new(Method::Patch, "http://localhost/home", Version::Http11),
            headers: RequestHeaders::new(1400, true, true),
    ...
    fn test_try_read_no_body_request() {
        ...
        let expected_request = Request {
            request_line: RequestLine::new(Method::Patch, "http://localhost/home", Version::Http11),
            headers: RequestHeaders::new(0, true, true),
            body: None,
            // files: Vec::new(),
        };
        assert_eq!(request, expected_request);
    ...
    fn test_try_read_segmented_req_line() {
        ...
        let expected_request = Request {
            request_line: RequestLine::new(Method::Patch, "http://localhost/home", Version::Http11),
            headers: RequestHeaders::new(0, false, false),
            body: None,
            // files: Vec::new(),
        };
        assert_eq!(request, expected_request);
    ...
    fn test_try_read_double_request() {
        ...
        let expected_request_first = Request {
            request_line: RequestLine::new(Method::Patch, "http://localhost/home", Version::Http11),
            headers: RequestHeaders::new(26, false, true),
            body: Some(Body::new(b"this is not\n\r\na json \nbody".to_vec())),
            // files: Vec::new(),
        };
        ...
        let expected_request_second = Request {
            ...
            headers: RequestHeaders::new(23, false, false),
