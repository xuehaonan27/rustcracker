...
impl Hypervisor {
    ...
    fn new_with_jailer(config: &HypervisorConfig) -> Result<Self> {
    ...
    fn new_without_jailer(config: &HypervisorConfig) -> Result<Self> {
    ...
    pub fn ping_remote(&mut self) -> Result<()> {
    ...
    fn logger_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn metrics_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn boot_source_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn drives_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn network_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn vsock_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    /// CPU configuration.
    fn cpu_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn machine_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    /// Balloon configure.
    fn balloon_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn entropy_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn init_metadata_configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    fn configure(&mut self, config: &MicroVMConfig) -> Result<()> {
    ...
    pub fn start(&mut self, config: &MicroVMConfig) -> Result<()> {
...
impl Hypervisor {
    ...
    pub fn patch_balloon(&mut self, amount_mib: i64) -> Result<()> {
    ...
    pub fn patch_mmds(&mut self, content: String) -> Result<()> {
    ...
    pub fn patch_vm(&mut self, state: VmState) -> Result<()> {
